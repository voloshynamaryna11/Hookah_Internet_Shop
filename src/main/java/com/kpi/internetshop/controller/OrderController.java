...
import com.kpi.internetshop.mapper.ProductMapper;
...
public class OrderController {
    ...
    public OrderController(OrderService orderService, ShoppingCartService shoppingCartService, UserService userService, ItemService itemService) {
